...
Here's the breakdown of skills for the top-paying Data Analyst positions:
  SQL (100%): Required in all roles; the core foundation.
  Python (87.5%): Preferred programming language over R (50%).
  Tableau (75%): Dominant BI tool, ahead of Power BI (25%).
  AWS/Azure (25%): Top-paying skills, averaging ~$222.5k.
  DevOps Tools (25%): Git/Jira integration highlights modern engineering workflows.
[
  {
    "job_id": 552322,
